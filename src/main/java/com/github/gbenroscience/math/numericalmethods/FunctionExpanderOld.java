 ...
 */
public class FunctionExpanderOld {
    ...
    public FunctionExpanderOld(double xLower, double xUpper, int degree, int precision, Function function) {
        this.xLower = xLower;
        this.xUpper = xUpper;
        this.degree = degree;
     ...
     *
     */
    public FunctionExpanderOld(String expression, int precision) {
...
//remove all commas and whitespaces.
    ...
    public static void main(String args[]) {
        ...
        FunctionExpanderOld polynomial = new FunctionExpanderOld("poly(@(x)(x-1)(x+2)(3+x),1,20,4)", DOUBLE_PRECISION);//var x=1;..is to initialize the variable x.
        System.out.println("------------" + polynomial.getPolynomial());

        FunctionExpanderOld expand = new FunctionExpanderOld("poly(@(x)sin(x),-100,100,70)", DOUBLE_PRECISION);//var x=1;..is to initialize the variable x.
